...
# Configuration
GKE_DEPLOYMENT_FILE="catalog.yaml"
GKE_DEPLOYMENT_NAME="catalog-deployment"
...
until curl -s -o /dev/null -w "%{http_code}" "34.91.124.111.nip.io/catalog/products" | grep -q "200"; do
